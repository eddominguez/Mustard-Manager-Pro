                ...
                <div class="container-fluid">
                    <div class="card shadow mb-5" style="margin-top: -10px;">
                        <div class="card-body" style="padding-bottom: px;height: 100px;margin-top: 0px;">
                            <div class="row">
                                <div class="col"><a class="btn" role="button" data-bs-hover-animate="pulse" style="margin: 10px;font-weight: bold;background-color: rgb(115,163,255);color: rgb(255,255,255);margin-left: 480px;" href="r_performance.jsp">Review</a><a class="btn"
                                        role="button" data-bs-hover-animate="pulse" style="margin: 10px;font-weight: bold;color: rgb(21,4,4);background-color: rgb(255,255,255);" href="r_budget.jsp">Budget</a><a class="btn" role="button" data-bs-hover-animate="pulse"
                                        style="margin: 10px;font-weight: bold;color: rgb(21,4,4);background-color: rgb(255,255,255);" href="r_ratings.jsp">Ratings</a></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body" style="margin-top: 0px;">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table dataTable my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Name<i class="fas fa-sort-alpha-down" style="margin-left: 10px;"></i></th>
                                            <th class="text-center">Job Position<i class="fas fa-sort-alpha-down" style="margin-left: 10px;"></i></th>
                                            <th class="text-center">Department<i class="fas fa-sort-alpha-down" style="margin-left: 10px;"></i></th>
                                            <th class="text-center">Employee ID<i class="fas fa-sort-alpha-down" style="margin-left: 10px;"></i></th>
                                            <th class="text-center">Last Review Period<i class="fas fa-sort-amount-down" style="margin-left: 10px;"></i></th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-left"><img class="rounded-circle mr-2" width="30" height="30" src="assets/img/avatars/avatar1.jpeg?h=0ecc82101fb9a10ca459432faa8c0656"><a class="text-black-50" href="r_profile.jsp">Sarah Hoffman</a></td>
                                            <td class="text-center">Software Engineeer</td>
                                            <td class="text-center">Application Management</td>
                                            <td class="text-center">K99281</td>
                                            <td class="text-center">11-28-2019</td>
                                            <td class="text-center"><a class="text-dark" href="r_profile.jsp"><i class="fas fa-chevron-circle-right" data-bs-hover-animate="pulse"></i></a></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Database Management</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Server Management</td>
