...
String val0 = tableinfo[0];
String val1 = tableinfo[1];
String val2 = tableinfo[2];
String val3 = tableinfo[3];
String val4 = (String) request.getParameter("userid");
session.setAttribute("targetid", val4);
session.setAttribute("whereAmIFrom", "r_profile");
%>
<html>
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        </a><a class="btn active text-center" role="button" data-bs-hover-animate="pulse" style="margin: 0px 0px 0px 340px;background-color: #ffffff;color: rgb(21,4,4);font-weight: bold;margin-left: 190px;" href="MainController">Employees</a>
                        <a
                                ...
                                <div class="card-body" style="padding-bottom: px;height: 180px;margin-top: -10px;">
                                    <div class="row">
                                        <div class="col"><img class="rounded-circle" src="assets/img/avatars/avatar1.jpeg?h=0ecc82101fb9a10ca459432faa8c0656" style="padding-bottom: px;">
                                            <h5 style="width: 250px;margin-left: 80px;margin-top: -55px;padding-bottom: 10px;font-weight: bold;color: rgb(81,81,86);font-size: 18px;"><%=val0%></h5>
                                            <h5 style="width: 250px;margin-left: 90px;margin-top: -15px;padding-bottom: px;font-size: 16px;">Database Analyst</h5>
                                        </div>
                                        <div class="col">
                                            <h5 style="color: rgb(81,81,86);font-weight: bold;font-size: 18px;width: 120px;"><%=val1%></h5>
                                            <h5 style="color: rgb(133,135,150);font-size: 16px;margin-left: 10px;width: 120px;">Projected Rating</h5>
                                        </div>
                                        <div class="col">
                                            <h5 style="color: rgb(81,81,86);font-weight: bold;font-size: 18px;width: 120px;"></h5>
                                            <h5 style="color: rgb(133,135,150);font-size: 16px;margin-left: 10px;width: 150px;">Last Review Date</h5>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col">
                                            <h5 style="color: rgb(81,81,86);font-weight: bold;font-size: 18px;width: 120px;margin-left: 100px;"><%=val2%></h5>
                                            <h5 style="color: rgb(133,135,150);font-size: 16px;margin-left: 110px;width: 120px;">Employee Id</h5>
                                        </div>
                                        <div class="col">
                                            <h5 style="color: rgb(81,81,86);font-weight: bold;font-size: 18px;width: 120px;margin-left: 80px;"><%=val3%></h5>
                                            <h5 style="color: rgb(133,135,150);font-size: 16px;margin-left: 90px;width: 150px;">Supervisor</h5>
                                        </div>
                                        <div class="col">
                                            <h5 style="color: rgb(81,81,86);font-weight: bold;font-size: 18px;width: 200px;margin-left: 45px;"></h5>
                                            <h5 style="color: rgb(133,135,150);font-size: 16px;margin-left: 60px;width: 150px;">Department</h5>
                                        </div>
                                        <div class="col">
                                            <h5 style="color: rgb(81,81,86);font-weight: bold;font-size: 18px;width: 120px;margin-left: 25px;"></h5>
                                            ...
                                            <div class="card-body" style="padding-bottom: 0px;">
                                                <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
	                                                <form class="user" action="MainController" value="">
				                                        <div class="form-group"><input class="form-control form-control-user" type="text" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Projected Rating ID" name="ratingID"></div>
				                                        <button class="btn btn-primary btn-block text-white btn-user" data-bs-hover-animate="pulse"
