...
<html>
<%
System.out.println("all_employees: I was requested.");
String tableinfo = (String) session.getAttribute("popinfo");
System.out.println("all_employees: I've populated myself with the information sent in 'popinfo'.");
session.setAttribute("whereAmIFrom", "all_employees");
%>
<head>
    <meta charset="utf-8">
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Projected Rating</th>
                                            <th class="text-center">PR Status</th>
                                            <th class="text-center">Salary Review</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <!-- This is where are the employee information goes -->
                                        <%=tableinfo%>
                                    </tbody>
                                    <tfoot>
                                        <tr></tr>
