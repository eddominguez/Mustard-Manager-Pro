            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button><img src="assets/img/purp_fed.jpg?h=7d381502c413aec07ef3d15a064f2f69" style="width: 120px;margin: 30px;"><a class="btn active text-center" role="button"
                            data-bs-hover-animate="pulse" style="margin: 0px 0px 0px 290px;background-color: #73a3ff;color: rgb(255,255,255);font-weight: bold;" href="managerEmployees.html">Employees</a><a class="btn text-center d-xl-flex" role="button" data-bs-hover-animate="pulse"
                            style="margin: 0px 0px px 200px;margin-left: 20px;color: rgb(21,4,4);background-color: rgb(255,255,255);font-weight: bold;padding-left: 12px;padding-right: 0px;" href="managerReport.html">Reports &nbsp;</a><a class="btn text-center d-xl-flex"
                            role="button" data-bs-hover-animate="pulse" style="margin: 0px 0px px 200px;margin-left: 20px;color: rgb(21,4,4);background-color: rgb(255,255,255);font-weight: bold;" href="m_jobs.html">Manager</a>
                        ...
                        <a
                            class="text-dark" href="login.html"><i class="fas fa-sign-out-alt" data-bs-hover-animate="rubberBand" style="width: 16px;height: 16px;margin-right: 20px;"></i></a>
                    </div>
                </nav>
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"><a class="text-dark" href="managerPerformance.html"><i class="fas fa-check" style="color: rgb(112,127,222);"></i></a></td>
