                    ...
                    <div class="card shadow" style="margin-top: -10px;">
                        <div class="card-body">
                            <div class="row" style="margin-bottom: 20px;">
                                <div class="col"><a href="r_performance.html"></a><a class="btn" role="button" data-bs-hover-animate="pulse" style="margin: 10px;font-weight: bold;background-color: rgb(115,163,255);color: rgb(255,255,255);margin-left: 480px;" href="r_performance.html">Review</a>
                                    <a
                                        class="btn" role="button" data-bs-hover-animate="pulse" style="margin: 10px;font-weight: bold;color: rgb(21,4,4);background-color: rgb(255,255,255);margin-left: 6px;" href="r_budget.html">Budget</a><a class="btn" role="button" data-bs-hover-animate="pulse" style="margin: 10px;font-weight: bold;color: rgb(21,4,4);background-color: rgb(255,255,255);margin-left: 6px;" href="r_ratings.html">Ratings</a></div>
                            </div>
